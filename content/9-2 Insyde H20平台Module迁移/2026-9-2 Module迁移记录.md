...
![[module-migration-architecture.svg|640]]

**图1｜两平台包/文件结构迁移架构图**

![[module-migration-mindmap.svg|640]]
...
![[module-migration-filemap.svg|640]]
...
该文件和fdf文件成对存在，dsc决定要不要编译该模块，fdf决定编码后放进哪个固件卷
分**平台级**和**包级**两层。
...
![[module-migration-header-diff.svg|640]]
...
![[module-migration-steps.svg|640]]
...
![[module-migration-feasibility.svg|640]]
